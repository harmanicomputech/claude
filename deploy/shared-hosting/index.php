 ...
 * itself lives in an "election-shield" folder *outside* the web root, next to
...
foreach ([__DIR__.'/../election-shield', __DIR__.'/../../election-shield', __DIR__.'/../../../election-shield'] as $candidate) {
...
if ($appPath === null) {
    ...
    exit('Election Shield: the "election-shield" folder was not found next to this web root.');
}
